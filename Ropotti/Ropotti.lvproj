...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Main_simpler_algorithm.vi" Type="VI" URL="../Main_simpler_algorithm.vi"/>
		<Item Name="PID_Separate.vi" Type="VI" URL="../PID_Separate.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="ReadEncoders(subvi).vi" Type="VI" URL="../ReadEncoders(subvi).vi"/>
			<Item Name="ReadEncoders.vi" Type="VI" URL="../ReadEncoders.vi"/>
			<Item Name="SetMotors (SubVI).vi" Type="VI" URL="../SetMotors (SubVI).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build">
			<Item Name="Ropotti_v2.0" Type="Zip File">
				<Property Name="Absolute[0]" Type="Bool">false</Property>
				<Property Name="BuildName" Type="Str">Ropotti_v2.0</Property>
				<Property Name="Comments" Type="Str"></Property>
				<Property Name="DestinationID[0]" Type="Str">{73E24DA3-1CE1-4917-AAD0-B3498FCED23F}</Property>
				<Property Name="DestinationItemCount" Type="Int">1</Property>
				<Property Name="DestinationName[0]" Type="Str">Destination Directory</Property>
				<Property Name="IncludedItemCount" Type="Int">1</Property>
				<Property Name="IncludedItems[0]" Type="Ref">/My Computer</Property>
				<Property Name="IncludeProject" Type="Bool">true</Property>
				<Property Name="Path[0]" Type="Path">../../builds/Ropotti/Ropotti_v2.0/Ropotti.zip</Property>
				<Property Name="ZipBase" Type="Str">NI_zipbasedefault</Property>
			</Item>
		</Item>
	</Item>
	<Item Name="NI-myRIO-1900-0315334d-KISA" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-0315334d-KISA</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Color.vi" Type="VI" URL="../../../../../Desktop/Tikun sis?lt?/World Skills Robot 2017 Sample/Color.vi"/>
		<Item Name="Encoders(subvi).vi" Type="VI" URL="../Encoders(subvi).vi"/>
		<Item Name="EncoderSpeedMise_original.vi" Type="VI" URL="../EncoderSpeedMise_original.vi"/>
		<Item Name="global.vi" Type="VI" URL="../global.vi"/>
		<Item Name="IR_demo.vi" Type="VI" URL="../IR_demo.vi"/>
		<Item Name="IR_Range.vi" Type="VI" URL="../IR_Range.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="Main_simpler_algorithm.vi" Type="VI" URL="../Main_simpler_algorithm.vi"/>
		<Item Name="Parallax PING Read Distance.vi" Type="VI" URL="../Parallax PING Read Distance.vi"/>
		<Item Name="Ping_mean.vi" Type="VI" URL="../Ping_mean.vi"/>
		<Item Name="ReadSensors.vi" Type="VI" URL="../ReadSensors.vi"/>
		<Item Name="ReadEncoders.vi" Type="VI" URL="../ReadEncoders.vi"/>
		<Item Name="Sensors.vi" Type="VI" URL="../../../../../Desktop/Sensors.vi"/>
		<Item Name="Servos(SubVI).vi" Type="VI" URL="../Servos(SubVI).vi"/>
		<Item Name="SetMotors (SubVI).vi" Type="VI" URL="../SetMotors (SubVI).vi"/>
		<Item Name="SetMotors.vi" Type="VI" URL="../SetMotors.vi"/>
		<Item Name="SetMotors_with_PID(SUBVI(subvi)).vi" Type="VI" URL="../SetMotors_with_PID(SUBVI(subvi)).vi"/>
		<Item Name="SetMotors_with_PID(SUBVI).vi" Type="VI" URL="../SetMotors_with_PID(SUBVI).vi"/>
		<Item Name="SetMotors_with_PID.vi" Type="VI" URL="../SetMotors_with_PID.vi"/>
		<Item Name="DriveTest.vi" Type="VI" URL="../DriveTest.vi"/>
		<Item Name="PID_Separate(subvi).vi" Type="VI" URL="../PID_Separate(subvi).vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="Voltage to Distance.vi" Type="VI" URL="../../../../../Desktop/Tikun sisältö/Part 2 - myRIO Interfacing/Sharp IR Sample/Support VIs/Voltage to Distance.vi"/>
			<Item Name="ReadEncoders(subvi).vi" Type="VI" URL="../ReadEncoders(subvi).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
